...
comb201618_namcs$SEX <- as_factor(comb201618_namcs$SEX)
#comb201618_namcs$BREAST <- as_factor(comb201618_namcs$BREAST)
comb201618_namcs$RACERETH <- as_factor(comb201618_namcs$RACERETH)
comb201618_namcs$PAYTYPER <- as_factor(comb201618_namcs$PAYTYPER)
#comb201618_namcs$CANCER <- as_factor(comb201618_namcs$CANCER)
# comb201618_namcs$SIGMOID <- as_factor(comb201618_namcs$SEX)
# comb201618_namcs$MENTAL <- as_factor(comb201618_namcs$SEX)
# comb201618_namcs$PSYCHOTH <- as_factor(comb201618_namcs$SEX)
# comb201618_namcs$PT <- as_factor(comb201618_namcs$PT)
# comb201618_namcs$DME <- as_factor(comb201618_namcs$SEX)
# comb201618_namcs$STRESMGT <- as_factor(comb201618_namcs$BREAST)
# comb201618_namcs$EXERCISE <- as_factor(comb201618_namcs$RACERETH)
# comb201618_namcs$HEPTEST <- as_factor(comb201618_namcs$PAYTYPER)
# comb201618_namcs$DIETNUTR <- as_factor(comb201618_namcs$CANCER)
# comb201618_namcs$ETOHED <- as_factor(comb201618_namcs$SEX)
# comb201618_namcs$HIV <- as_factor(comb201618_namcs$SEX)
# comb201618_namcs$TOBACED <- as_factor(comb201618_namcs$SEX)
# comb201618_namcs$DEPRESS <- as_factor(comb201618_namcs$CANCER)
# comb201618_namcs$COLON <- as_factor(comb201618_namcs$SEX)
# comb201618_namcs$OCCUPY <- as_factor(comb201618_namcs$SEX)
# comb201618_namcs$SUBST <- as_factor(comb201618_namcs$SEX)
# comb201618_namcs$CAM <- as_factor(comb201618_namcs$PT)
# comb201618_namcs$HOMEHLTH <- as_factor(comb201618_namcs$SEX)
# comb201618_namcs$BONEDENS <- as_factor(comb201618_namcs$BREAST)
# comb201618_namcs$CervicalCaScreen <- as_factor(comb201618_namcs$RACERETH)
# comb201618_namcs$MAMMO <- as_factor(comb201618_namcs$PAYTYPER)
# comb201618_namcs$GENETIC <- as_factor(comb201618_namcs$CANCER)
# comb201618_namcs$RADTHER <- as_factor(comb201618_namcs$SEX)
