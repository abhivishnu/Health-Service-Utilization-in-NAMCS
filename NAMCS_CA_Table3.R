...
variables <- c('CSTRATM','PATWT','CPSUM','CANCER','MAMMO',  'COLON','MENTAL','PT','PSYCHOTH','BREAST','DEPRESS','SKIN','DIETNUTR','EXERCISE','STRESMGT',
...
comb201618_namcs$AnyService <- comb201618_namcs$DME + comb201618_namcs$COLON + comb201618_namcs$SIGMOID + 
  ...
  comb201618_namcs$OCCUPY + comb201618_namcs$BREAST + comb201618_namcs$DEPRESS + 
  comb201618_namcs$SKIN + comb201618_namcs$DIETNUTR + comb201618_namcs$EXERCISE + 
